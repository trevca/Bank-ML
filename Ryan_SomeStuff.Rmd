...
```{r}
bank_data=read_delim("bank-additional/bank-additional-full.csv",";",col_names=TRUE,col_types = "dfffffffcfddddfdddddf")#,col_types = "dffccffffcddddfdddddf")
```
...
Analyze the economic variables
```{r}
...
boost=gbm(y~.,data=train,distribution="bernoulli",n.trees=1000, shrinkage=shrink)
summary(boost)

...
Using our functions, we will perform Bayesian Optimization to find the optimal shrinkage parameter, and we will then perform model training on the train set. "upsample_output" is a function we created that will perform the train/test split as we did above, perform Bayesian Optimization as above, and then train a model.
```{r,message=FALSE}
set.seed(1)
n = nrow(bank_data)
